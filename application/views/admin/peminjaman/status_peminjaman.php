...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-danger">Peminjaman Belum Disetujui</h1>
        <small>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Berikut merupakan data peminjaman belum disetujui</h6>
        </div>
        <div class="card-body">
            ...
            <a class='btn btn-success' href="peminjamanSukses">
                ...
                <span>
                    Daftar Peminjaman Sudah Disetujui
                </span>
            </a>
                ...
                <table class="table table-bordered table-striped text-center" id="dataTable" width="100%"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-primary">Setujui Peminjaman</th>
                            <!-- <th class="text-primary">Status Peminjaman</th> -->
                        </tr>
                    </thead>
                    <tbody>
