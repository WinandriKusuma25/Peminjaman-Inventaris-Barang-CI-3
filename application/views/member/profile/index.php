...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <small>
            <div class="text-muted"> Profile &nbsp; / &nbsp; <a href="<?php echo base_url("member/profile"); ?>">My
                    profile</a>
            </div>
        </small>
    </div>
    ...
    <div class="card mb-3" style="max-width: 700px;">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Akun Profile</h6>
        </div>
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <p class="card-text "><small class="text-muted">Tgl.
                        ...
                        <br>
                        <br>
                        <a href="<?php echo base_url("member/profile/edit"); ?>" class="btn btn-primary">Edit
                            Profile</a>
                        <a href="<?php echo base_url("member/Change_Password"); ?>" class="btn btn-primary">Ubah
                            Password</a>
