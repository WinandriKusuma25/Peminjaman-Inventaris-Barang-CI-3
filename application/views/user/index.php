...
<head>
    ...
    <title>Kominfo Batu | Beranda</title>
    <link href="<?= base_url(); ?>https://fonts.googleapis.com/css?family=Heebo:400,500,700|Fira+Sans:600" rel="stylesheet">
    <link rel="stylesheet" href="<?= base_url(); ?>assets_user/dist/css/style.css">
...
<body class="is-boxed has-animations">
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <img src="<?= base_url(); ?>assets/images/logo_login.png" alt="" width="15%">
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="text-primary" >Diskominfo Batu</h1>
	                        <p class="hero-paragraph">Mempermudah peminjaman inventaris alat Dinas Kominfo Balai Kota Among Tani Batu</p>
							<div class="hero-form field field-grouped">
								<div class="control control-expanded">
								<a class="button button-primary button-block" href="<?= base_url('auth/registration'); ?>">Registrasi</a>
								</div>
								<div class="control">
									<a class="button button-primary  btn-user button-block" href="<?= base_url('auth'); ?>">Login</a>
								</div>
							</div>
						</div>
                    ...
                    <div class="features-inner section-inner">
                        <div class="features-header text-center">
                            <div class="container-sm">
                                <h2 class="text-primary mt-0">Alur Peminjaman</h2>
                                <center><img src="<?= base_url(); ?>assets/images/background_login.png" width="50%";></center>
                                <p class="section-paragraph">Website ini merupakan Website Peminjaman Inventaris Alat di Diskominfo Kota Batu.</p>
                            </div>
                        </div>
						<div class="features-wrap">
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">1. Registrasi</h4>
                                    <p class="text-sm">Pertama, lakukan registrasi telebih dahulu. Isikan semua form yang ada di halaman registrasi. </p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">2. Login</h4>
                                    <p class="text-sm">Setelah Registrasi, lakukan login sesuai dengan email dan password yang Anda masukkan pada saat registrasi. </p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">3. Melakukan Peminjaman Alat</h4>
                                    <p class="text-sm">Setelah Login, lalu masuk ke dalam halaman website. Pilih alat apa saja yang akan di pinjam dan lakukan transaksi peminjaman tersebut</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">4. Konfirmasi Peminjaman oleh Admin</h4>
                                    <p class="text-sm">Admin mengecek data dan menyetujui peminjaman. Lalu mengubah status sudah dikembalikan apabila peminjam sudah mengembalikan alat.</p>
                                </div>
                            </div>
						</div>
                    </div>
                    ...
                    <div class="brand footer-brand">
                        <a href="#">
							<svg width="32" height="32" xmlns="http://www.w3.org/2000/svg">
								...
								<g fill="none" fill-rule="evenodd">
                                <img src="<?= base_url(); ?>assets/images/logo_login.png" alt="" width="25%">
                                <br>
                                <div class="footer-copyright">&copy;Copyright &copy; Dinas Komunikasi dan Informatika Kota Batu <?= date('Y') ?></div>
								</g>
							</svg>
                        </a>
                    </div>
    ...
    <script src="<?= base_url(); ?>assets_user/dist/js/main.min.js"></script>
</body>
</html>